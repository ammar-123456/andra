  ...
  return (
    <div className="mt-8">
      ...
      <div className="mt-4 p-4 bg-gray-50 rounded-md border border-gray-200">
        <h4 className="font-semibold text-gray-800 mb-2">Betalningsmottagare</h4>
        <div className="flex items-center">
          <div className="mr-3">
            <Image 
              src="/images/logo.png" 
          ...
          <div>
            <p className="font-medium">WAS Redovisningskonsulter</p>
            <p className="text-sm text-gray-600">Org.nr: 800809-0774</p>
          </div>
        </div>
      </div>
    </div>
